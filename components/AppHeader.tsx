...
export function AppHeader({ subtitle }: { subtitle?: string }) {
  return (
    <header className="sticky top-0 z-30 border-b-2 border-sand-deep bg-sand/95 backdrop-blur">
      <div className="mx-auto flex max-w-2xl items-center justify-between gap-2 px-4 py-2">
        ...
        <Link
          ...
          className="tap flex shrink-0 items-center gap-1.5 rounded-full bg-white px-3 py-2 text-[11px] font-bold whitespace-nowrap shadow-[0_3px_0_rgb(42_30_70/0.12)]"
        >
          <Pictogram name="lineal" className="h-5 w-5" />
          So bewerten wir
        </Link>
      </div>
    </header>
